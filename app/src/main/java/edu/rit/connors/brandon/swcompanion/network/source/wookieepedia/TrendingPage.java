...
public class TrendingPage extends SourcePage {

    public TrendingPage() {
        super(0, "Trending", "https://starwars.fandom.com/wiki/Main_Page", true);
    }
    ...
    public List<Article> parse(Document document) {
        ...
        Elements elements = document.select("div.mobile-main-page__trending-articles > " +
